...
const EditRelationshipModal: React.FC<EditRelationshipModalProps> = ({
    ...
    const [relationshipType, setRelationshipType] = useState(relationship?.relationship_type || 'parent_child');
    const [member1Id, setMember1Id] = useState(relationship?.member_1_id || '');
    ...
    useEffect(() => {
        if (relationship) {
            ...
            setMember1Id(relationship.member_1_id);
            setMember2Id(relationship.member_2_id);
            setRelationSubtype(relationship.relation_subtype);
        }
    }, [relationship]);
            ...
            <div className="card max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                        <button type="button" onClick={handleDelete} className="btn-secondary flex items-center justify-center text-red-600 hover:bg-red-50 hover:text-red-700 hover:border-red-200" disabled={loading}>
